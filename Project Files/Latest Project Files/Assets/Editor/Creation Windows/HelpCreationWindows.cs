...
public class HelpCreationWindows : EditorWindow
{
    [MenuItem("Editor Windows/Help Creation Windows")]
    public static void ShowWindow()
    {
        GetWindow<HelpCreationWindows>("Item Setting Creation");
    }

    private void OnGUI()
    {
        GUILayout.Label("Help Creation Windows", EditorStyles.boldLabel);
        GUILayout.Label("Generates all the help info for the HelpManager");
